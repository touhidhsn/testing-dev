              ...
              <div className='col-xl-6 col-lg-6 col-12'>
                <div className='wpo-static-hero-inner'>
                  <div data-swiper-parallax='300' className='slide-title'>
                    <h2>
                      <span>Hi 👋</span>I am Touhid.
                    </h2>
                  </div>
                  <div data-swiper-parallax='300' className='slide-sub-title'>
                    <h5>Software developer & UI designer</h5>
                  </div>
                  <div data-swiper-parallax='400' className='slide-text'>
                    <p>
                      I am a dedicated and passionate web developer with
                      extensive expertise in HTML, CSS, JavaScript, TypeScript,
                      and React, coupled with strong knowledge in Figma for
                      design.
                    </p>
                  </div>
